...
public class Q48 {
    ...
    static long[] segment = new long[4 * N];
    ...
    public static long query(int index, int low, int high, int left, int right) {
        ...
        int mid = (low + high) / 2;
        long l = query(2 * index + 1, low, mid, left, right);
        long r = query(2 * index + 2, mid + 1, high, left, right);
        return l + r;
    }
